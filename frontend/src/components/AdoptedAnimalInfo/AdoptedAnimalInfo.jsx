import './AdoptedAnimalInfo.css'
import CustomBtn from '../CustomBtn/CustomBtn';

function AdoptedAnimalInfo({ animalName, animalAge, animalWeight, favoriteFood, animalCategory, photo, description }) {
...
export default AdoptedAnimalInfo;